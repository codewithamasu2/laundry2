...
import InQueueIcon from "../assets/icons/in-queue.svg";

export default function OrderDetailQueuePage() {
      ...
      <main className="px-4 pt-6">
        <div className="bg-white rounded-2xl shadow-lg mx-auto max-w-md p-5">
          <div className="flex items-center justify-between mb-2">
            ...
            <img src={InQueueIcon} alt="in queue" />
          </div>
          <hr />
          <div className="flex justify-center py-4">
            <img src={LaundryOnGoingIcon} alt="queue" className="h-16 w-16" />
          </div>
          {/* ...sisa detail sama */}
          <div className="mb-3">
